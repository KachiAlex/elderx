...
const ServiceProviderLayout = () => {
  ...
  const navigation = [
    ...
    { name: 'Calls', href: '/service-provider/calls', icon: Phone, roles: ['caregiver', 'doctor', 'admin'] },
    ...
    { name: 'Medical Records', href: '/service-provider/medical-records', icon: Users, roles: ['caregiver', 'doctor', 'admin'] },
