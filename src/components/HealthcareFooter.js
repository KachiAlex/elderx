        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center mb-4">
              <div className="flex h-9 w-9 items-center justify-center rounded-2xl bg-gradient-to-br from-blue-400 via-blue-400 to-blue-500 shadow-lg shadow-blue-500/30 mr-3">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-4">
              <li><a href="#" className="text-base text-slate-300 hover:text-blue-300 transition-colors">Health Monitoring</a></li>
              <li><a href="#" className="text-base text-slate-300 hover:text-blue-300 transition-colors">Medication Management</a></li>
              <li><a href="#" className="text-base text-slate-300 hover:text-blue-300 transition-colors">Appointment Scheduling</a></li>
              <li><a href="#" className="text-base text-slate-300 hover:text-blue-300 transition-colors">Caregiver Support</a></li>
            </ul>
          </div>
