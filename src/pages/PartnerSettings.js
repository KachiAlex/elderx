...
import { getPartnerSettings, updatePartnerSettings } from '../api/partnerAPI';
...
const PartnerSettings = () => {
  ...
  useEffect(() => {
    const fetchSettings = async () => {
      ...
      try {
        const fetchedSettings = await getPartnerSettings(institutionId);
  ...
  const handleSave = async () => {
    ...
    setSaving(true);
    try {
      await updatePartnerSettings(institutionId, settings);
