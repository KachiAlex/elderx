...
exports.processEmailQueue = exports.sendPaymentLinkEmail = void 0;
...
const fromEmail = ((_b = functions.config().sendgrid) === null || _b === void 0 ? void 0 : _b.from_email) || process.env.FROM_EMAIL || 'noreply@caremaster.com';
if (sendGridApiKey) {
...
const sendPaymentLinkEmail = async (data, context) => {
    var _a;
    try {
        ...
        for (const doc of emailQueueSnapshot.docs) {
            ...
            try {
                ...
                await doc.ref.update({
                    ...
                    sendGridMessageId: ((_b = (_a = result[0]) === null || _a === void 0 ? void 0 : _a.headers) === null || _b === void 0 ? void 0 : _b['x-message-id']) || null
                });
                ...
                const errorMessage = ((_f = (_e = (_d = (_c = error === null || error === void 0 ? void 0 : error.response) === null || _c === void 0 ? void 0 : _c.body) === null || _d === void 0 ? void 0 : _d.errors) === null || _e === void 0 ? void 0 : _e[0]) === null || _f === void 0 ? void 0 : _f.message) || (error === null || error === void 0 ? void 0 : error.message) || String(error);
                ...
                if (attempts >= 3) {
                    await doc.ref.update({
                        ...
                        error: errorMessage,
                        failedAt: admin.firestore.FieldValue.serverTimestamp(),
                        sendGridError: ((_g = error === null || error === void 0 ? void 0 : error.response) === null || _g === void 0 ? void 0 : _g.body) || null
                    });
